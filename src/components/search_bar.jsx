      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <form onSubmit={handleSearch}>
          <button type="submit" style={{ background: "#3B3B4F", color: "white" }}>
            <svg class="ais-SearchBox-submitIcon" alt="Search" xmlns="https://www.w3.org/2000/svg" width="12" height="12" viewBox="0 0 40 40">
          ...
          <input type="text" onChange={handleInputChange} placeholder="Search "
            style={{ background: "#3B3B4F", color: "white", outline:"none"}} />
