      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        >
          <button type="submit" style={{ background: "#3B3B4F", color: "white"}}>
            <svg className="ais-SearchBox-submitIcon" alt="Search" xmlns="https://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 40 40">
          ...
          <input type="text" value={searchTerm} onChange={handleInputChange} placeholder="Search" size="40"
